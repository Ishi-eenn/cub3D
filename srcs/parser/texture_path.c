...
/*   Updated: 2023/12/11 03:00:25 by tsishika         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	parse_and_set_texture_path(t_data *data, char *line)
{
	...
	if (ft_strncmp(line, "NO ", 3) == 0)
		data->texture_path->north = duplicate_texture_path(line);
	else if (ft_strncmp(line, "SO ", 3) == 0)
		data->texture_path->south = duplicate_texture_path(line);
	else if (ft_strncmp(line, "WE ", 3) == 0)
		data->texture_path->west = duplicate_texture_path(line);
	else if (ft_strncmp(line, "EA ", 3) == 0)
		data->texture_path->east = duplicate_texture_path(line);
	else
